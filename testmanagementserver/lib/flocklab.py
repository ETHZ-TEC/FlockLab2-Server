...
##############################################################################
#
# daqpin_abbr2num - Convert a pin abbreviation to its corresponding number
#
##############################################################################
def daqpin_abbr2num(abbr=""):
    if not abbr:
        return errno.EINVAL
    abbrdict =    {
                    'RST' : 0,
...
##############################################################################
#
# daqlevel_str2abbr - Convert a pin level string to its abbreviation
#
##############################################################################
def daqlevel_str2abbr(levelstr=""):
    if not levelstr:
        return errno.EINVAL
    strdict =    {
                'LOW'   : LOW,
